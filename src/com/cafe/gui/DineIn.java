...
public class DineIn extends javax.swing.JDialog {
    ...
    private boolean printBill(String invoiceID, String date) {
        ...
        try {
            File billResource = new File(System.getProperty("user.dir")+File.separator+"reports/cafe_dineIn_bill.jasper");
            File kotResource = new File(System.getProperty("user.dir")+File.separator+"reports/cafe_dineIn_kot.jasper");
