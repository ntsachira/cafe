 ...
 * @author User
 */
public class GrnManagement extends javax.swing.JPanel implements SetupUI {
    ...
    private void saveGrn() {
        ...
        if (itemList.isEmpty()) {
            ...
            //insert grn
            grn.saveGrn();
            if (grn.saveGrnItems(itemList)) {
                this.dashboard.setSuccessStatus("GRN Saved successfully");
                dashboard.getUser().updateUserActivity(User.UserActivity.GRN_ADDED);
                resetGrn();
            } else {
