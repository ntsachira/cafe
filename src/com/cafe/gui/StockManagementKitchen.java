...
public class StockManagementKitchen extends javax.swing.JPanel {
    ...
    private void loadStockTable(String query) {
        ResultSet resultSet = MySql.exucute("SELECT `qty`,`expire_date`, `kitchen_item_category`.`name` AS 'category',\n"
    ...
    private void loadCategories() {
        ResultSet resultSet = MySql.exucute("SELECT * FROM `kitchen_item_category`");
